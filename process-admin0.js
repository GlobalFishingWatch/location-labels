...
import { MIN_POPULATIONRANK_COUNTRY, MAX_POPULATIONRANK_COUNTRY } from "./config.js";
...
export async function processAdmin0() {
  ...
  return countries.features.flatMap(country => {
    ...
    return {
        ...
        properties: {
          type: "country",
          populationRank: Math.round(countryPopulationRankScale(country.properties.POP_EST || 0)),
          size: 16,
